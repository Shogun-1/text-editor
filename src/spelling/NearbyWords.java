...
public class NearbyWords implements SpellingSuggest {
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		while (!queue.isEmpty() && suggestionsNumber < numSuggestions && thresholdCounter <= THRESHOLD) {
			String currentWord = queue.element();
			queue.remove();

			List<String> nearbyWords = distanceOne(currentWord, true);
